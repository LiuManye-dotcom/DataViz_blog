...
2. **Poor colour choice:** Imports and Exports are displayed using two different colours in the original graph. However, both colours are too light hence they do not contrast sufficiently with each other. Using brighter colours will improve the aesthetics of the visualization. 
