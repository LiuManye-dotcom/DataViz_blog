...
description: |
  The purpose of the DataViz makeover is to improve on the original visualization. The limitations of the original graph will be pointed out. An alternative data to solve the original issues. 
author:
  - name: Liu Manye
    url: {}
date: 05-24-2021
